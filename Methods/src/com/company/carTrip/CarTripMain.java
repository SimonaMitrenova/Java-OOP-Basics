...
public class CarTripMain {
    public static void main(String[] args) throws IOException {
        ...
        Double speed = Double.valueOf(params[0]);
        Double fuel = Double.valueOf(params[1]);
        Double fuelEconomy = Double.valueOf(params[2]);
        ...
        while (true){
            ...
            switch (command[0]){
                case "Travel":
                    double distance = Double.valueOf(command[1]);
                    car.travel(distance);
                    break;

                case "Refuel":
                    double litters = Double.valueOf(command[1]);
                    car.refuel(litters);
                    break;
